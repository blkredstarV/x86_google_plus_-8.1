...
# virtual methods
.method public final a(IILjava/io/InputStream;)Ljzm;
    .locals 3

    .prologue
    .line 187
    invoke-static {p1, p2}, Ljzi;->b(II)Z
    ...
    .line 188
    invoke-static {p1, p2, p3}, Ljzi;->b(IILjava/io/InputStream;)Landroid/graphics/Bitmap;
    ...
    .line 195
    invoke-static {v0}, Ljzi;->a(Landroid/graphics/Bitmap;)[B

    move-result-object v2

    .line 2082
    iput-object v2, v1, Ljzn;->a:[B

    .line 2107
    new-instance v2, Ljzm;

    .line 3006
    invoke-direct {v2, v1}, Ljzm;-><init>(Ljzn;)V
    ...
    .line 190
    :cond_0
    invoke-static {p1, p2, p3}, Ljzi;->c(IILjava/io/InputStream;)Landroid/graphics/Bitmap;
