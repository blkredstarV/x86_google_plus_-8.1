...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lemo;->a:Z

    sput-boolean v1, Lemo;->d:Z
    ...
    sput-object v0, Lemo;->f:Ljava/lang/Object;

    sput-object v2, Lemo;->g:Ljava/lang/String;

    sput-object v2, Lemo;->h:Ljava/lang/Integer;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lemo;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lemo;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1, v1}, Lemo;->a(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {v3}, Lemo;->a(Landroid/content/pm/PackageManager;)Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-virtual {v2, v1, v4}, Lemp;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    :cond_2
    invoke-virtual {v2, v1, v0}, Lemp;->a(Landroid/content/pm/PackageInfo;Z)Z
...
.method public static a(Landroid/content/pm/PackageManager;)Z
    ...
    .prologue
    .line 0
    invoke-static {p0}, Lemo;->b(Landroid/content/pm/PackageManager;)Z
...
.method public static b(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v0}, Lemo;->a(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private static b(Landroid/content/pm/PackageManager;)Z
    ...
    .line 0
    sget-object v2, Lemo;->f:Ljava/lang/Object;
    ...
    .line 9000
    sget-object v4, Lemp;->a:Lemp;

    .line 0
    const/4 v4, 0x1

    new-array v4, v4, [Lest;

    const/4 v5, 0x0

    sget-object v6, Lfae;->a:[Lest;
    ...
    invoke-static {v3, v4}, Lemp;->a(Landroid/content/pm/PackageInfo;[Lest;)Lest;
...
.method public static c(Landroid/content/Context;)I
    ...
    .line 1000
    sget-object v3, Lemo;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sget-object v5, Lemo;->f:Ljava/lang/Object;

    monitor-enter v5

    :try_start_1
    sget-object v3, Lemo;->g:Ljava/lang/String;
    ...
    sput-object v3, Lemo;->g:Ljava/lang/String;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    sput-object v3, Lemo;->h:Ljava/lang/Integer;
    :try_end_2
    ...
    :goto_2
    :try_start_3
    sget-object v3, Lemo;->h:Ljava/lang/Integer;
    ...
    sget-object v2, Lemo;->g:Ljava/lang/String;
    ...
    .line 2000
    sget-object v5, Lemp;->a:Lemp;

    .line 0
    invoke-static {p0}, Llp;->r(Landroid/content/Context;)Z

    move-result v5

    if-eqz v5, :cond_8

    sget-object v5, Lfae;->a:[Lest;

    invoke-static {v3, v5}, Lemp;->a(Landroid/content/pm/PackageInfo;[Lest;)Lest;
    ...
    invoke-static {v5, v6}, Lemp;->a(Landroid/content/pm/PackageInfo;[Lest;)Lest;
    ...
    new-array v6, v6, [Lest;

    const/4 v7, 0x0

    aput-object v5, v6, v7

    invoke-static {v3, v6}, Lemp;->a(Landroid/content/pm/PackageInfo;[Lest;)Lest;
    :try_end_8
...
.method public static d(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, p0, v0, v2}, Lemj;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v1, v0}, Lemk;-><init>(I)V
    ...
    invoke-direct {v2, v0, v3, v1}, Leml;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method public static e(Landroid/content/Context;)V
    ...
    sget-object v0, Lemo;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
