...
.method public static a(Landroid/app/Notification$Builder;Lhd;)Landroid/os/Bundle;
    .locals 3

    .prologue
    .line 258
    invoke-virtual {p1}, Lhd;->a()I

    move-result v0

    invoke-virtual {p1}, Lhd;->b()Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {p1}, Lhd;->c()Landroid/app/PendingIntent;
    ...
    invoke-virtual {p1}, Lhd;->d()Landroid/os/Bundle;
    ...
    invoke-static {v2}, Lfpp;->toBundleArray([Lhy;)[Landroid/os/Bundle;
...
.method public static a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    :cond_0
    :try_start_1
    sget-object v0, Lhg;->b:Ljava/lang/reflect/Field;
    ...
    .line 225
    sput-object v0, Lhg;->b:Ljava/lang/reflect/Field;
    ...
    .line 230
    sget-object v3, Lhg;->b:Ljava/lang/reflect/Field;
...
.method public static a([Lhd;)Ljava/util/ArrayList;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    invoke-virtual {v3}, Lhd;->b()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v3}, Lhd;->c()Landroid/app/PendingIntent;
    ...
    invoke-virtual {v3}, Lhd;->d()Landroid/os/Bundle;
    ...
    invoke-virtual {v3}, Lhd;->e()[Lhy;

    move-result-object v3

    invoke-static {v3}, Lfpp;->toBundleArray([Lhy;)[Landroid/os/Bundle;
...
.method public static a(Lgh;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Z)V
    .locals 2
    ...
    invoke-interface {p0}, Lgh;->a()Landroid/app/Notification$Builder;
...
.method public static a(Lgh;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Ljava/lang/CharSequence;)V
    .locals 2
...
.method public static a(Lgh;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Ljava/util/ArrayList;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
