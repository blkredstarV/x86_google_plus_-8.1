...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lejb;->b:Ljava/lang/String;
    ...
    sput-object v0, Lejb;->c:Landroid/content/ComponentName;
...
.method public static a(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-direct {v1, p1, p2, v0}, Lejc;-><init>(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method static a(Landroid/content/Context;Landroid/content/ComponentName;Lejf;)Ljava/lang/Object;
    .locals 5
    ...
    invoke-static {p0}, Leqz;->a(Landroid/content/Context;)Leqz;

    move-result-object v2

    const-string v0, "GoogleAuthUtil"

    invoke-virtual {v2, p1, v1, v0}, Leqz;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {v1}, Lesr;->a()Landroid/os/IBinder;

    move-result-object v0

    invoke-interface {p2, v0}, Lejf;->a(Landroid/os/IBinder;)Ljava/lang/Object;
    :try_end_0
    ...
    invoke-virtual {v2, p1, v1, v3}, Leqz;->b(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
...
.method static a(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lemo;->d(Landroid/content/Context;)V
    :try_end_0
    ...
    iget-object v0, v0, Lemr;->b:Landroid/content/Intent;

    invoke-direct {v4, v0}, Landroid/content/Intent;-><init>(Landroid/content/Intent;)V

    .line 0
    invoke-direct {v1, v2, v3, v4}, Lejg;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0}, Lemk;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Leiz;-><init>(Ljava/lang/String;)V
...
.method static d(Landroid/content/Context;Ljava/lang/String;)[Landroid/accounts/Account;
    ...
    .line 0
    invoke-static {p0}, Lemj;->b(Landroid/content/Context;)V
